...
export const EmailConfirmation = ({ navigation, route }) => {
  ...
  // Check if they OTP and input match
  ...
  function handleVerifyClick(enteredOTPArray) {
   ...
   // Check to see if email has been passed to email verify screen?
  // console.log("just received the email: ", email);
